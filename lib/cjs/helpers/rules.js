...
exports.addStyleEmptyRule = exports.calculateStyleArray = exports.getRuleRange = exports.getRuleAllowedModes = exports.getRuleDefaultMode = void 0;
...
var getRuleAllowedModes = function (rule) {
    if (numberRules.includes(rule)) {
        return [rules_1.RULE_MODES.slider, rules_1.RULE_MODES.text];
    }
    if (colorRules.includes(rule)) {
        return [rules_1.RULE_MODES.color, rules_1.RULE_MODES.text];
    }
    return [rules_1.RULE_MODES.text];
};
exports.getRuleAllowedModes = getRuleAllowedModes;
