...
var RuleName = function (_a) {
    ...
    var _d = (0, react_1.useState)(!value), isEdit = _d[0], setIsEdit = _d[1];
    ...
    return (react_1.default.createElement(StyledNameWrapper, { fullwidth: fullwidth },
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            react_1.default.createElement(InputText_1.default, { transparent: !isEdit, ref: inputRef, type: "text", value: localValue, placeholder: "Property", onChange: handleChange, onBlur: handleCloseEdit, onClick: handleOpenEdit, order: order }))));
};
