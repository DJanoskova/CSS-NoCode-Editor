...
var CSSPropertiesContext_1 = __importDefault(require("../../context/CSSPropertiesContext"));
var OptionDropdown_1 = __importDefault(require("../UI/OptionDropdown"));
...
var RuleName = function (_a) {
    ...
    var cssProperties = (0, react_1.useContext)(CSSPropertiesContext_1.default);
    var availableProperties = (0, react_1.useMemo)(function () {
        return cssProperties.filter(function (property) { return property.startsWith(localValue.toLowerCase()); });
    ...
    return (react_1.default.createElement(StyledNameWrapper, { fullwidth: fullwidth },
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            ...
            isDropdownOpen && react_1.default.createElement(OptionDropdown_1.default, { options: availableProperties, wrapperRef: inputRef }))));
};
