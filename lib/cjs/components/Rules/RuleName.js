...
var RuleName = function (_a) {
    ...
    return (react_1.default.createElement(StyledNameWrapper, { fullwidth: fullwidth },
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            react_1.default.createElement(InputText_1.default, { ref: inputRef, type: "text", value: localValue, placeholder: "Property", onChange: handleChange, 
                // onBlur={handleCloseEdit}
                onClick: handleOpenEdit, order: order, transparent: true }))));
};
