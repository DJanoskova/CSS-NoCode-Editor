...
var CSSBuilder = function (_a) {
    ...
    var id = (0, react_1.useState)(new Date().getTime())[0];
    ...
    return (react_1.default.createElement(ThemeContext_1.default.Provider, { value: combinedTheme },
        react_1.default.createElement(StyledWrapper, { fontSize: combinedTheme.fontSize, color: combinedTheme.color, spacing: combinedTheme.spacing, "data-id": id, ref: wrapperRef }, localStyle.map(function (rule, index) {
