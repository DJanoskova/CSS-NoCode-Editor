...
var CSSBuilder = function (_a) {
    ...
    return (react_1.default.createElement(ThemeContext_1.default.Provider, { value: combinedTheme },
        react_1.default.createElement(StyledWrapper, { fontSize: combinedTheme.fontSize, color: combinedTheme.color, spacing: combinedTheme.spacing }, localStyle.map(function (rule, index) {
