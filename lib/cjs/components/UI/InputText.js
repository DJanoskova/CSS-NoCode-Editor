...
var InputStyled = styled_components_1.default.input(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  border-radius: ", "px;\n  background-color: ", ";\n  box-sizing: border-box;\n  padding: 1px 3px;\n  text-align: inherit;\n  width: 100%;\n  outline: none;\n  border: 2px ", " solid;\n  font-family: inherit;\n  font-size: inherit;\n  color: ", ";\n  \n  &:focus, &[value=\"\"] {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &:focus {\n    border-color: ", ";\n  }\n"], ["\n  border-radius: ", "px;\n  background-color: ", ";\n  box-sizing: border-box;\n  padding: 1px 3px;\n  text-align: inherit;\n  width: 100%;\n  outline: none;\n  border: 2px ", " solid;\n  font-family: inherit;\n  font-size: inherit;\n  color: ", ";\n  \n  &:focus, &[value=\"\"] {\n    background-color: ", ";\n    color: ", ";\n  }\n\n  &:focus {\n    border-color: ", ";\n  }\n"])), function (_a) {
    ...
    var _b = _a.isValid, isValid = _b === void 0 ? true : _b, inputError = _a.inputError;
    return isValid ? 'transparent' : inputError;
}, function (_a) {
...
var InputText = (0, react_1.forwardRef)(function (props, ref) {
    ...
    return (react_1.default.createElement(InputStyled, __assign({ inputBg: theme.inputBg, accent: theme.accent, radius: theme.radius || 0, type: "text", ref: ref, "data-editor-order": props.order, inputColor: theme.inputColor, color: theme.color, inputError: theme.inputError }, props)));
});
