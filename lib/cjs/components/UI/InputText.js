...
var InputText = (0, react_1.forwardRef)(function (props, ref) {
    ...
    return (react_1.default.createElement(InputStyled, __assign({ inputBg: theme.inputBg, accent: theme.accent, radius: theme.radius || 0, type: "text", ref: ref, "data-editor-order": props.order }, props)));
});
