...
var CSSBuilder = function (_a) {
    ...
    return (React.createElement(ThemeContext.Provider, { value: combinedTheme },
        React.createElement(StyledWrapper, { fontSize: combinedTheme.fontSize, color: combinedTheme.color, spacing: combinedTheme.spacing }, localStyle.map(function (rule, index) {
